...
public:
     ...
     */
    void drawModel(const Model &model, const float* modelViewMatrix, const float* color, float useTexture, float alpha) const;
    ...
    void setModelViewMatrix(float *modelViewMatrix) const;
    void setColor(const float* color) const;
    void setUseTexture(float useTexture) const;
